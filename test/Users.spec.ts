...
describe("Users", function () {
  it("should get a user", async function () {
    const response = await soundcloud.users.get("https://soundcloud.com/oksuu");
  ...
  it("should get user tracks", async function () {
    const response = await soundcloud.users.tracks(
      "https://soundcloud.com/oksuu"
    );
  ...
  it("should get user playlists", async function () {
    const response = await soundcloud.users.playlists(
